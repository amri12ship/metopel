...
<body class="flex min-h-screen items-center justify-center bg-gray-100 p-6 font-sans text-gray-900 antialiased">
    <div class="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 text-center shadow-sm">
        <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-red-100 text-3xl font-black text-red-600">403</div>
        <h1 class="mt-4 text-xl font-bold text-gray-900">Akses Ditolak</h1>
        ...
        <div class="mt-6 flex justify-center gap-3">
            ...
            <a href="{{ url()->previous() !== url()->full() ? url()->previous() : '/' }}" class="rounded-lg border border-gray-300 px-5 py-2 text-sm font-semibold text-gray-600 transition hover:bg-gray-50">Kembali</a>
        </div>
    </div>
</body>
</html>