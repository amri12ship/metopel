...
<body class="flex min-h-screen items-center justify-center bg-gray-100 p-6 font-sans text-gray-900 antialiased">
    <div class="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 text-center shadow-sm">
        <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-red-100 text-3xl font-black text-red-600">500</div>
        <h1 class="mt-4 text-xl font-bold text-gray-900">Terjadi Kesalahan</h1>
        <p class="mt-2 text-sm text-gray-500">Maaf, terjadi kendala pada server. Silakan coba beberapa saat lagi.</p>
